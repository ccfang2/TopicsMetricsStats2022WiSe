...
# In simulation of the original paper, authors use the estimated covariance 
# matrix from 12 recently published papers. But here, I will only do simulation
# using matrix from one of them, i.e., Bailey AER 2015. For simulation results of 
# remaining 11 papers, please refer to the shiny app I created.
bailey <- data[[1]]
betahat <- bailey$beta
sigma <- bailey$sigma
